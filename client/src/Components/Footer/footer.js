            ...
            <div className="footer-content pb10">
              <div className="row">
                <div className="footer-widget ">
                  <div className="footer-menu ul-li-block"></div>
                </div>
                <div className="footer-menu ul-li-block ">
                  ...
                  <ul>
                    <li>
                      ...
                      <a href="https://www.linkedin.com/in/noeleivadeveloper/">
                    ...
                    <li>
                      ...
                      <a href="https://www.linkedin.com/in/katiemillsdev">
                        <i className="fab fa-linkedin" />
                      </a>
                    </li>
                    <li>
                      ...
                      <a href="https://www.linkedin.com/in/jameszimmermann">
                        <i className="fab fa-linkedin" />
                      </a>
                    </li>
                    <li>
                      ...
                      <a href="https://www.linkedin.com/in/james-hooven">
                        <i className="fab fa-linkedin" />
                      </a>
                    </li>
                  </ul>
